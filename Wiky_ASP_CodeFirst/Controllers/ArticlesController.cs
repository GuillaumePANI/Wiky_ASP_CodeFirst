...
namespace Wiky_ASP_CodeFirst.Controllers
{
    public class ArticlesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id_Article,Theme,Auteur,DateCreation,Image,Contenu")] Article article)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id_Article,Theme,Auteur,DateCreation,Image,Contenu")] Article article)
        {
            if (ModelState.IsValid)
            {
